...
Apagar_tiro:
	...
	slli t0, t0, 20	#Formato o enderec
	...
	sub t3, t4, a3	#Aramzeno em t3 o stride que e 320 - 8

	li t1, 0		#Contador para as linhas
	li t2, 0		#Contador para as colunas

	la t5, cor_fundo	#carrego a cor de fundo
	lw t6, 0(t5)	#Coloco a cor do cenario para imprimir
Apagar_tiro_linha:
	...
	blt t2, a3, Apagar_tiro_linha	#enquanto t2 for menor que a largura
